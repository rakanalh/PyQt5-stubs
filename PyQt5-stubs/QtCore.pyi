...
class pyqtSignal:
    def __init__(self, *types: typing.Any, name: str = ..., arguments: typing.List[str] = ...) -> None: ...
...
def pyqtSlot(*types: typing.Union[type, str], name: typing.Optional[str] = ..., result: typing.Optional[typing.Any] = ...) -> typing.Callable[..., typing.Callable[..., None]]: ...
